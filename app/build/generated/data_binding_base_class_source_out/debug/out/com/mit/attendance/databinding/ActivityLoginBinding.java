...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final AutoCompleteTextView spinnerSemester;
  ...
  private ActivityLoginBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnLogin,
      ...
      @NonNull ProgressBar progressBar, @NonNull AutoCompleteTextView spinnerSemester,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      AutoCompleteTextView spinnerSemester = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityLoginBinding((ScrollView) rootView, btnLogin, etEmail, etPassword,
          progressBar, spinnerSemester, tvStatus);
    }
